  ...
  return (
    <section className="w-full pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="inline-block p-3 bg-gray-100 rounded-full mb-6 animate-fade-in">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mb-10 animate-fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <Button className="gradient-bg text-white hover:opacity-90 px-6 py-6" asChild>
            <Link to="/text-reverser">
              Try Text Reverser <ArrowRight size={16} className="ml-2" />
            </Link>
          </Button>
          <Button variant="outline" className="border-nuno-purple text-nuno-purple hover:bg-nuno-purple/10 px-6 py-6" asChild>
            <Link to="/about">
              Learn More
            </Link>
          </Button>
